...
7. **Importación y Exportación JSON:** Las reglas se exportan e importan en formato JSON mediante Android Storage Access Framework (`CreateDocument` y `GetContent`).
